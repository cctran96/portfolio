...
const Logo = () => {
    return (
        <div className="ani-logo">
            <motion.svg variants={SvgVar} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 520 470" initial="start" animate="end">
                ...
                <motion.g id="Layer_1" data-name="Layer 1">
                    <motion.path variants={innerVar} style={{fill: "#dcffe8"}}d="M343.5,220.8c-10.3,0-20.3,0-30.2,0c-1.6,0-2.3-0.6-2.7-2.3c-5.4-20.1-18.5-32.8-38.6-37.2
